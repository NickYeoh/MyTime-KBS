...
{
    public class AttendanceAnalysisViewModel
    {
        ...
        public IEnumerable<SelectListItem> SelectListOperand { get; set; }
        public IEnumerable<SelectListItem> SelectListNumberOfDay { get; set; }
